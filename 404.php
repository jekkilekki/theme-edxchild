...
<main id="site-content" role="main">
	...
	<header class="section-inner error404-content">
		<h1 class="entry-title"><?php esc_html_e( 'Oops! Page Not Found', 'edxchild' ); ?></h1>
	</header>

	<div class="section-inner thin error404-content">

		<div class="intro-text"><p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'edxchild' ); ?></p></div>
	...
	$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'edxchild' ), convert_smilies( ':)' ) ) . '</p>';
